...
__version__ = run_path('src/dvc_poc_model/version.py')['__version__']
...
setup(
    name="DVC-POC-MODEL",
    version=__version__,
    author="Moritz Osterberger",
    author_email="moritz.osterberger@alexanderthamm.com",
    description="In order to test DVC a POC with a test data science usecase is created",
    license="proprietary",
    url="",
    packages=find_packages("src"),
    package_dir={"": "src"},
    package_data={'dvc_poc_model': ['res/*']},
